...
var question_component_1 = __webpack_require__("../../../../../src/app/note/question/question.component.ts");
var routes = [
    ...
    { path: 'quest', component: question_component_1.QuestionComponent },
...
module.exports = "<app-user-logout></app-user-logout>\n<button\n    (click)=\"newquest()\"\n>New Questions!    \n</button>\n<p>\n  note works!\n</p>\n\n<p *ngFor=\"let quest of questions\">Questions: {{ quest.content }}</p>"
...
var NoteComponent = /** @class */ (function () {
    function NoteComponent(_route, _userService) {
        this._route = _route;
        this._userService = _userService;
    ...
    NoteComponent.prototype.ngOnInit = function () {
        ...
        this._userService.getQuestions(function (user) {
            console.log;
        }, function (err) {
            console.log(err);
        });
    };
    NoteComponent.prototype.newquest = function () {
...
/***/ "../../../../../src/app/note/question/question.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/note/question/question.component.html":
/***/ (function(module, exports) {

module.exports = "<button\n    (click)=\"home()\"\n>Home    \n</button>\n\n<div \n    class=\"question-new-div\"\n>\n    <form \n      (submit)=\"onSubmit(); createForm.resetForm()\"\n      #createForm=\"ngForm\"\n    >\n      <label>Question:</label>\n      <input \n          type=\"text\" \n          name=\"question\"\n          required\n          minlength=\"3\"\n          [(ngModel)]=\"question.content\"\n          #question1=\"ngModel\"\n      />\n      <small\n          class=\"errors\"\n          [hidden]=\"question1.valid || (question1.untouched && !createForm.submitted)\"\n      >Question is required (Minny length 3).\n      </small>\n      <button \n          class=\"question-new-submit\"\n          [disabled]=\"!createForm.valid\" \n          type=\"submit\">Submit</button>\n    </form>\n\n</div>"

/***/ }),

/***/ "../../../../../src/app/note/question/question.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var user_service_1 = __webpack_require__("../../../../../src/app/user/user.service.ts");
var router_1 = __webpack_require__("../../../router/esm5/router.js");
var question_1 = __webpack_require__("../../../../../src/app/user/question.ts");
var QuestionComponent = /** @class */ (function () {
    function QuestionComponent(_route, _userService) {
        this._route = _route;
        this._userService = _userService;
    }
    ...
    QuestionComponent.prototype.onSubmit = function () {
        ...
        this._userService.createQuest(this.question, function (quest) {
    ...
    QuestionComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("../../../../../src/app/note/question/question.component.html"),
            styles: [__webpack_require__("../../../../../src/app/note/question/question.component.css")]
        }),
        __metadata("design:paramtypes", [router_1.Router,
            user_service_1.UserService])
    ], QuestionComponent);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.createQuest = function (question, callback, errorback) {
        var _this = this;
        console.log(question);
        this._http.post('/questions', question).subscribe(function (res) {
            var question = res.json();
            _this.questions += question;
    ...
    UserService.prototype.getQuestions = function (callback, errorback) {
        var _this = this;
